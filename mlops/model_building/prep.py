...
DATASET_PATH = "hf://datasets/diwakarpandeygreatlearning-alt/bank-customer-churn/bank_customer_churn.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="diwakarpandeygreatlearning-alt/bank-customer-churn",
        repo_type="dataset",
    )
